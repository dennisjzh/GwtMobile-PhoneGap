...
public class Accelerometer {
	...
	public static native void getCurrentAcceleration(Callback callback) /*-{
		$wnd.navigator.accelerometer.getCurrentAcceleration(function(acceleration) {
	    	callback.@com.touchonmobile.gwtmobile.phonegap.client.Accelerometer.Callback::onSuccess(Lcom/touchonmobile/gwtmobile/phonegap/client/Accelerometer$Acceleration;)(acceleration);
	    }, function() {
	    	callback.@com.touchonmobile.gwtmobile.phonegap.client.Accelerometer.Callback::onError()();
	    });
	}-*/;
