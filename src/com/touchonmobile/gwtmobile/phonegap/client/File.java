...
public class File {
	...
	public static native void testFileExists(String fileName, FileMgrCallback callback) /*-{
		$wnd.navigator.fileMgr.testFileExists(fileName, function(success){
			callback.@com.touchonmobile.gwtmobile.phonegap.client.File.FileMgrCallback::onSuccess(Z)(success);
		}, function(error){
			callback.@com.touchonmobile.gwtmobile.phonegap.client.File.FileMgrCallback::onError(Lcom/touchonmobile/gwtmobile/phonegap/client/File$FileError;)(error);
		});
	}-*/;
	...
	public static native void getFreeDiskSpace(FreeDiskSpaceCallback callback) /*-{
		$wnd.navigator.fileMgr.getFreeDiskSpace(function(freeDiskSpace){
			callback.@com.touchonmobile.gwtmobile.phonegap.client.File.FreeDiskSpaceCallback::onSuccess(D)(freeDiskSpace);
		}, function(error){
			callback.@com.touchonmobile.gwtmobile.phonegap.client.File.FreeDiskSpaceCallback::onError(Lcom/touchonmobile/gwtmobile/phonegap/client/File$FileError;)(error);
		});
	}-*/;
	...
	public static class FileBase extends JavaScriptObject {
		...
		public final native void onProgress(Callback callback) /*-{
			this.onprogress = function(event) {
				callback.@com.touchonmobile.gwtmobile.phonegap.client.File.Callback::onEvent(Lcom/touchonmobile/gwtmobile/phonegap/client/File$Event;)(event);
			};
		}-*/;
