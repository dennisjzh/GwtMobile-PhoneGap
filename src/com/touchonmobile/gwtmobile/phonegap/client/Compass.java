...
public class Compass {
	...
	public static native void getCurrentHeading(Callback callback) /*-{
		$wnd.navigator.compass.getCurrentHeading(function(heading) {
	    	callback.@com.touchonmobile.gwtmobile.phonegap.client.Compass.Callback::onSuccess(F)(heading);
	    }, function() {
	    	callback.@com.touchonmobile.gwtmobile.phonegap.client.Compass.Callback::onError()();
	    });
	}-*/;
