...
public class Media extends JavaScriptObject {
	...
	public static native Media newInstance(String src, Callback callback) /*-{
		return new $wnd.Media(src, function() {
			callback.@com.touchonmobile.gwtmobile.phonegap.client.Media.Callback::onSuccess()();
		}, function(error) {
			callback.@com.touchonmobile.gwtmobile.phonegap.client.Media.Callback::onError(Lcom/touchonmobile/gwtmobile/phonegap/client/Media$MediaError;)(error);
		});
	}-*/;
	...
	public native final void getCurrentPosition(PositionCallback callback) /*-{
		this.getCurrentPosition(function(position) {
			callback.@com.touchonmobile.gwtmobile.phonegap.client.Media.PositionCallback::onSuccess(I)(position);
		}, function(error) {
			callback.@com.touchonmobile.gwtmobile.phonegap.client.Media.PositionCallback::onError(Lcom/touchonmobile/gwtmobile/phonegap/client/Media$MediaError;)(error);
		});
	}-*/;
