...
public class Camera {
	...
	private native static void getPicture(Callback callback, JavaScriptObject options) /*-{
		$wnd.navigator.camera.getPicture(function(imageData) {
	    	callback.@com.touchonmobile.gwtmobile.phonegap.client.Camera.Callback::onSuccess(Ljava/lang/String;)(imageData);
	    }, function(message) {
	    	callback.@com.touchonmobile.gwtmobile.phonegap.client.Camera.Callback::onError(Ljava/lang/String;)(message);
		}, options);
	}-*/;
    ...
    public static class Options {
    	...
    	public native Options quality(int q) /*-{
    		this.@com.touchonmobile.gwtmobile.phonegap.client.Camera.Options::options.quality = q;
    	...
    	private native Options destinationType(int d) /*-{
			this.@com.touchonmobile.gwtmobile.phonegap.client.Camera.Options::options.destinationType = d;			
    		return this.@com.touchonmobile.gwtmobile.phonegap.client.Camera.Options::self;
		}-*/;
    	...
    	private native Options sourceType(int s) /*-{
			this.@com.touchonmobile.gwtmobile.phonegap.client.Camera.Options::options.sourceType = s;			
    		return this.@com.touchonmobile.gwtmobile.phonegap.client.Camera.Options::self;
		}-*/;

    	public native Options allowEdit(boolean b) /*-{
			this.@com.touchonmobile.gwtmobile.phonegap.client.Camera.Options::options.allowEdit = b;			
    		return this.@com.touchonmobile.gwtmobile.phonegap.client.Camera.Options::self;
		}-*/;
